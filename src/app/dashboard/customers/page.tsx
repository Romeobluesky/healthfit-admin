...
import { Trash2, FileText, MessageCircleMore, Search, Users, ChevronsLeft, ChevronLeft, ChevronRight, ChevronsRight, Download, MapPin, Loader2, MousePointer2, MousePointer2Off, RefreshCw, Calendar, Building2, Route, Fingerprint, ClipboardList } from "lucide-react";
...
export default function CustomersPage() {
  ...
  const colCount = 15 + (isAdminUser ? 2 : 0);
  ...
  const handleExcelDownload = () => {
    ...
    XLSX.writeFile(wb, `건강검진고객${partnerLabel}${partnershipLabel}${partnerIdLabel}${dateRange}${regionLabel}${statusLabel}${buttonCheckLabel}${inflowPathLabel}.xlsx`);
  };
